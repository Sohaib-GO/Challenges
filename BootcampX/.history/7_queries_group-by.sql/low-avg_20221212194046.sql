...
SELECT students.name AS name, AVG(assignment_submissions.duration) AS average_completion_time, AVG(assignments.assignment_submissions.duration) AS average_estimated_time_to_complete
FROM students
