...
SELECT students.name AS name, AVG(assignment_submissions.d) AS average_completion_time, AVG(assignments.estimated_time_to_complete) AS average_estimated_time_to_complete
FROM students
