...
SELECT students AS name, AVG(assignment_submissions.time_to_complete) AS average_completion_time, AVG(assignments.estimated_time_to_complete) AS average_estimated_time_to_complete
FROM students
