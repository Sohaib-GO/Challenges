...
const getAllProperties = function (options, limit = 10) {
  ...
  // 3
  if (options.city) { // if the city is not empty
    queryParams.push(`%${options.city}%`); // add the city to the queryParams array
    queryString += `WHERE city LIKE $${queryParams.length} `; // add the city to the queryString `;
  }
